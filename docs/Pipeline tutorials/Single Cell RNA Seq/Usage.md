...
![scrna seq pipeline](/img/scrnaseq_pipelines.png)
...
Select the appropriate **aligner**, currently, we support the human genome.

![parameters information](/img/scrnaseq_pipeline_params.png)
...
![review information](/img/scrnaseq_review_and_submit.png)
